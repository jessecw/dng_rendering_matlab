function colorMatrix = FindXYZtoCamera_colorMatrix(white, fColorMatrix1, fColorMatrix2)
% colorMatrix = FindXYZtoCamera_colorMatrix(white, fColorMatrix1, fColorMatrix2)
% Author: Jesse Chen
